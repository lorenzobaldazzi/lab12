        ...
        for (int i = 0; i < size; i++) {
            for (int j = 0; j < size; j++) {
                ...
                button.addActionListener(e -> {
                    ...
                    logics.setValue(buttonPosition.x(), buttonPosition.y());
                    button.setText(logics.getValue(buttonPosition.x(), buttonPosition.y()));
                    if (logics.toQuit(buttonPosition.x(), buttonPosition.y())) {
                        dispose();
                    }
                });
